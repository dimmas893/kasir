                                ...
                                <tbody>
                                    @foreach ($user as $item)
                                        <tr>
                                            ...
                                            @endif
                                            <td>
                                                <form action="{{ url('/' . auth()->user()->level . '/user/' . $item->id) }}"
                                                    id="delete-form">
                                                    <a href="{{ url('/' . auth()->user()->level . '/user/' . $item->id . '/edit') }}"
    ...
    <script>
        ...
        function confirmDelete(button) {
            ...
            swal({
                ...
                if (willDelete) {
                    const form = button.closest('form'); // Temukan elemen form terdekat dari tombol delete
                    // Setelah pengguna mengkonfirmasi penghapusan, form akan dikirim ke server

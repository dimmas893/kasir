...
<section class="section">
    ...
    <div class="section-body">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ url('/' . auth()->user()->level . '/satuan/' . $satuan->id) }}" method="POST">
                    @method('PUT')
                    @csrf
                    ...
                    <a href="{{ url('/' . auth()->user()->level . '/satuan') }}" class="btn btn-sm btn-outline-warning"><i class="fas fa-caret-left"></i> Kembali</a>

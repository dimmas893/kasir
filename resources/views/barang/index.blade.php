                                    ...
                                    <tbody>
                                        @foreach ($barang as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <form
                                                        action="{{ url('/' . auth()->user()->level . '/barang/' . $item->id) }}"
                                                        id="delete-form">
                                                        <a href="{{ url('/' . auth()->user()->level . '/barang/' . $item->id . '/show') }}"
                                                            class="btn btn-sm btn-outline-info"><i class="fa fa-eye"></i>
                                                            Detail</a>

                                                        <a href="{{ url('/' . auth()->user()->level . '/barang/' . $item->id . '/edit') }}"
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        form.action = baseUrl + '/' + userLevel + '/barang/' +
